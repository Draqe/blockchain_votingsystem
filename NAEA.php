...
<!-------main body ------>    
    ...
    <!------ main content tag ----->    	
     	<div id="maincontent">
		<div class="well">	
	                <h1>Non-Academic Employee Association</h1>
			<blockqoute><hr></blockqoute>
            	...
            	<?php
					if ($sign == "admin"){
						...
						else if ($adminorg == "NAEA"){
							$orgbase = "/blockchain_votingsystem/NAEA.php";
						}
					}
					else{
						if ($org == "FA"){
							...
							if ($orgbase == $_SERVER['PHP_SELF']){
								echo '<div class="form-group">';
									echo '<div class="form-control" style="height:auto" align="right">';
										echo 'The Voting process will end at <font class="text-danger"><strong>'.$settime.'</strong></font>.';
									echo '</div>';
								echo '</div>';
							}
							else{
