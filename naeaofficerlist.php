...
if ($sign == "admin"){
	...
	else if ($r == "/voting_system/naeaofficerlist.php"){
		$org = "NAEA";
	}
}
else{
	$org = $org;
		...
		$select = mysql_query("SELECT * FROM elec_con WHERE organization = 'NAEA' ORDER BY year_elec DESC")or die (mysql_error());
...
$officer_list="";
$select=mysql_query("SELECT * FROM tblofficer WHERE o_organization = 'NAEA' AND o_status = 1 ");
...
<!-------main body ------>    
	...
	<!------ menu tag ----->    	
        <div id="menutag" class="container">
           <h3 class="text-success"><strong>N. A. E. A.</strong></h3>
			<ul class="nav nav-pills nav-stacked col-sm-15" style="text-align:left; margin-right:-5%; margin-left:10%">
            	<li><a class="text-success" href="NAEA.php" id="menu">Home</a></li>
    ...
    <!------ main content tag ----->    	
     	<div id="maincontent">
            <div class="well">	
                 <h1>Officer List</h1>
      <span align="center" style="margin-top:-20px">of <strong>NON-ACADEMIC EMPLOYEE ASSOCIATION</strong> Year <font style="color:#F00"><?php echo $start_term;?> - N/A</font></span>
